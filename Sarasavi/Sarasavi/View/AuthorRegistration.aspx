<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AuthorRegistration.aspx.cs" Inherits="Sarasavi.View.AuthorRegistration" %>
       ...
       <li class="news">
        ...
        <li class="contact">
         ...
         <tr  >
                ...
                <tr>
                    <td colspan="2">
                         <div  class='panel panel-primary dialog-panel'>
                             ...
                             <h5 class='panel-heading'>Author Registation</h5>                  
                         </div>
                    </td>
            ...
            <tr >
                <td align="Right">
                    <asp:Label ID="Label1" runat="server" Text="AuthorID:"></asp:Label>
                </td>
                <td>
                    <asp:TextBox ID="txtAuthorID" runat="server" ReadOnly="True" CssClass="inputs" placeholder="Author ID"></asp:TextBox>
                </td>
            </tr>
             ...
             <tr>
                ...
                <td>   
                    <asp:TextBox ID="txtAuthorName" runat="server"  CssClass="inputs" placeholder="Author Name"></asp:TextBox>
                 </td>
            </tr>
